...
public class J01_PassThroughTest {
  ...
  public static final List<PassThroughPoint> PASS_THROUGH_STOP_A = List.of(point(STOP_A));
  public static final List<PassThroughPoint> PASS_THROUGH_STOP_C = List.of(point(STOP_C));
  public static final List<PassThroughPoint> PASS_THROUGH_STOP_D = List.of(point(STOP_D));
  ...
  private static PassThroughPoint point(int... stops) {
    return new PassThroughPoint(stops);
  }
}
